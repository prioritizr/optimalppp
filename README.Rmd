...
The latest development version of the _optimalppp R_ package can be installed using the following code. Please note that you will need install the _ggtree_ package from Bioconductor since it is not available on [The Comprehensive R Archive Network](https://cran.r-project.org/).
...
Please note that you will also need to install the [Gurobi optimization suite](http://www.gurobi.com/) and [_gurobi R_ package](https://www.gurobi.com/documentation/8.1/refman/r_api_overview.html). For instructions on installing these softwares, please refer to [this installation guide](https://cran.r-project.org/web/packages/prioritizr/vignettes/gurobi_installation.html).
