...
Rcpp::LogicalMatrix rcpp_random_solution(arma::sp_mat spp, double budget, arma::sp_mat branch_matrix, Rcpp::NumericVector branch_lengths, Rcpp::NumericVector costs, Rcpp::IntegerVector locked_in, Rcpp::IntegerVector locked_out, std::size_t n_solutions);
RcppExport SEXP _optimalppp_rcpp_random_solution(SEXP sppSEXP, SEXP budgetSEXP, SEXP branch_matrixSEXP, SEXP branch_lengthsSEXP, SEXP costsSEXP, SEXP locked_inSEXP, SEXP locked_outSEXP, SEXP n_solutionsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat >::type spp(sppSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_random_solution(spp, budget, branch_matrix, branch_lengths, costs, locked_in, locked_out, n_solutions));
    return rcpp_result_gen;
END_RCPP
}
