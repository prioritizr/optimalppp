...
Rcpp::List rcpp_mip_formulation(arma::sp_mat spp, arma::sp_mat actions, double budget, arma::sp_mat branch_matrix, Rcpp::NumericVector branch_lengths, Rcpp::NumericVector costs, Rcpp::IntegerVector locked_in, Rcpp::IntegerVector locked_out, std::size_t n_approx_points);
RcppExport SEXP _optimalppp_rcpp_mip_formulation(SEXP sppSEXP, SEXP actionsSEXP, SEXP budgetSEXP, SEXP branch_matrixSEXP, SEXP branch_lengthsSEXP, SEXP costsSEXP, SEXP locked_inSEXP, SEXP locked_outSEXP, SEXP n_approx_pointsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::sp_mat >::type spp(sppSEXP);
    ...
    rcpp_result_gen = Rcpp::wrap(rcpp_mip_formulation(spp, actions, budget, branch_matrix, branch_lengths, costs, locked_in, locked_out, n_approx_points));
    return rcpp_result_gen;
END_RCPP
}
// rcpp_ppp_epd
