...
// Dear reader,
//
// The function definition for `ppp_objective` lives here so that it can
// be accessed via the exported function `rcpp_ppp_objective` and
...
Rcpp::NumericVector ppp_objective(arma::sp_mat spp,
